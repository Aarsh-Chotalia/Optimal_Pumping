S_array=[0.001,0.005,0.01,0.05,0.1,0.5,1,5,10];
...
for o=1:9
    ...
    %Y_array(o,:)=smooth(E,9,'moving')
end
% Plot
figure('Color', 'w'); % White background
semilogx(1./S_array, max(Y_array,[],2)./mean(Y_array,2), 'b-o', 'LineWidth', 2, 'MarkerSize', 8);
hold on
...
ylabel('$E_{max}/\bar{E}$', 'FontSize', 18, 'Interpreter', 'latex');
...
print('maxbymean_vs_frequency','-dpng','-r300'); % PDF is vector quality
